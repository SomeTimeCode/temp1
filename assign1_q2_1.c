...
int main(int argc, char* argv[]) 
{
	...
	int YOUR_ARRAY[num_integers];
  for(int i = 0; i < num_integers; i++){
    YOUR_ARRAY[i] = pInputArray[i];
  }
	...
	mergesort4Way4Processes(YOUR_ARRAY, 0, num_integers);
	// recursiveMergesort(YOUR_ARRAY, 0, num_integers, max_num);
